...
},{"isarray":7}],14:[function(require,module,exports){
...
},{"./template":18,"page":12}],18:[function(require,module,exports){
'use strict';
...
},{"./home":17,"./signin":23,"./signup":25,"moment":9,"moment/locale/es":8,"page":12}],20:[function(require,module,exports){
'use strict';
...
module.exports = function (picture) {
  var el = void 0;
  function render(pic) {
    return yo(_templateObject, pic.liked ? 'liked' : '', pic.url, pic.description, pic.user.username, pic.user.avatar, pic.user.username, moment(pic.createdAt).fromNow(), like.bind(null, pic, true), like.bind(null, pic, false), pic.likes);
  }
...
},{"./template":26,"page":12}],26:[function(require,module,exports){
'use strict';
