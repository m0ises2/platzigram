...
},{"global/document":31,"hyperx":34,"on-load":57}],28:[function(require,module,exports){
...
},{"min-document":28}],32:[function(require,module,exports){
(function (global){
var win;
...
},{"./lib/locales":28,"./lib/main":43}],39:[function(require,module,exports){
/*
...
},{"./lib/locales":28,"./lib/main":52}],48:[function(require,module,exports){
/*
Copyright (c) 2014, Yahoo! Inc. All rights reserved.
Copyrights licensed under the New BSD License.
See the accompanying LICENSE file for terms.
...
},{"./lib/core.js":54,"./locale-data/complete.js":28}],54:[function(require,module,exports){
(function (global){
'use strict';
...
},{"global/document":31,"global/window":32}],58:[function(require,module,exports){
(function (process){
...
},{"./is-function":62,"./is-object":63,"./request-base":64,"./response-base":65,"./should-retry":66,"component-emitter":30}],62:[function(require,module,exports){
/**
...
var _templateObject = _taggedTemplateLiteral(['<footer class="side-footer">\n      <div class="container">\n        <div class="row">\n          <div class="col s12 l3 center-align">\n            <a href="#" data-activates="dropdown1" class="dropdown-button btn btn-flat"> ', ' </a>\n            <!-- Dropdown Structure-->\n            <ul id="dropdown1" class="dropdown-content">\n              <li><a href="" onclick=', ' >', '</a></li>\n              <li><a href="" onclick=', ' >', '</a></li>\n            </ul>\n          </div>\n          <div class="col s12 l3 push-l6 center-align">\xAE 2017 Platzigram  <a href="https://github.com/m0ises2/platzigram" target="_blank">m0ises2</a></div>\n        </div>\n      </div>\n    </footer>'], ['<footer class="side-footer">\n      <div class="container">\n        <div class="row">\n          <div class="col s12 l3 center-align">\n            <a href="#" data-activates="dropdown1" class="dropdown-button btn btn-flat"> ', ' </a>\n            <!-- Dropdown Structure-->\n            <ul id="dropdown1" class="dropdown-content">\n              <li><a href="" onclick=', ' >', '</a></li>\n              <li><a href="" onclick=', ' >', '</a></li>\n            </ul>\n          </div>\n          <div class="col s12 l3 push-l6 center-align">\xAE 2017 Platzigram  <a href="https://github.com/m0ises2/platzigram" target="_blank">m0ises2</a></div>\n        </div>\n      </div>\n    </footer>']);
...
var elem = yo(_templateObject, translate.message('language'), selectedLanguage.bind(null, 'en-US'), translate.message('english'), selectedLanguage.bind(null, 'es'), translate.message('spanish'));
...
var header = yo(_templateObject, translate.message('logout'));

module.exports = function (context, next) {
  var container = $('#header-container').empty();
...
},{"../translate":84,"yo-yo":68}],72:[function(require,module,exports){
'use strict';
...
page('/', /*Middlewares: */headerMiddleware, asyncloadPictures, /*Callback: */function (context, next) {
...
function loadPictures(context, next) {
  agent.get('/api/pictures').end(function (err, res) {
...
async function asyncloadPictures(context, next) {
  try {
    ...
    context.pictures = await fetch('/api/pictures').then(function (res) {
      return res.json();
    });
...
},{"../header":71,"./template":73,"axios":1,"page":58,"superagent":61}],73:[function(require,module,exports){
'use strict';

var _templateObject = _taggedTemplateLiteral(['<div class="container timeline">\n                <div class="row">\n                  <div class="col s8 offset-s2 m4 offset-m7 l4 offset-l5">\n                      <form onsubmit=', ' id="formUpload" enctype="multipart/form-data" class="formUpload">\n                        <div id="fileName" class="fileUpload btn btn-flat red lighten-1">\n                          <span>\n                            <i class="fa fa-camera" aria-hidden="true"></i>\n                          </span>\n                          <input id="file" name="picture" type="file" class="upload" onchange=', '/>\n                        </div>\n                        <button id="btnUpload" type="submit" class="btn btn-flat green darken-3 hide"> ', ' </button>\n                        <button id="btnCancel" type="button" class="btn btn-flat red accent-4 hide" onclick=', '> <i class="fa fa-times" aria-hidden="true"></i> </button>\n                      </form>\n                  </div>\n                </div>\n                <div class="row">\n                  <div class="col s12 m10 offset-m1 l6 offset-l3">\n                    ', '\n                  </div>\n                </div>\n              </div>'], ['<div class="container timeline">\n                <div class="row">\n                  <div class="col s8 offset-s2 m4 offset-m7 l4 offset-l5">\n                      <form onsubmit=', ' id="formUpload" enctype="multipart/form-data" class="formUpload">\n                        <div id="fileName" class="fileUpload btn btn-flat red lighten-1">\n                          <span>\n                            <i class="fa fa-camera" aria-hidden="true"></i>\n                          </span>\n                          <input id="file" name="picture" type="file" class="upload" onchange=', '/>\n                        </div>\n                        <button id="btnUpload" type="submit" class="btn btn-flat green darken-3 hide"> ', ' </button>\n                        <button id="btnCancel" type="button" class="btn btn-flat red accent-4 hide" onclick=', '> <i class="fa fa-times" aria-hidden="true"></i> </button>\n                      </form>\n                  </div>\n                </div>\n                <div class="row">\n                  <div class="col s12 m10 offset-m1 l6 offset-l3">\n                    ', '\n                  </div>\n                </div>\n              </div>']);
...
module.exports = function (pictures) {
  var el = yo(_templateObject, onSubmit, onchange, translate('upload'), cancel, pictures.map(function (elem) {
    return picture(elem);
  }));
  ...
  function onSubmit(oEvent) {
    ...
    agent.post('/api/pictures').send(data).end(function (err, res) {
      cancel();
      // Manejo de errores:
...
},{"../layout":76,"../pictureCard":77,"../translate":84,"superagent":61,"yo-yo":68}],74:[function(require,module,exports){
'use strict';
...
},{"./footer":70,"./home":72,"./signin":78,"./signup":80,"page":58}],75:[function(require,module,exports){
'use strict';
...
},{"yo-yo":68}],77:[function(require,module,exports){
'use strict';
...
module.exports = function (picture) {
  var el = void 0;
  function render(pic) {
    return yo(_templateObject, pic.liked ? 'liked' : '', pic.url, pic.description, pic.user.username, pic.user.avatar, pic.user.username, translate.date.format(pic.createdAt), like.bind(null, pic, true), like.bind(null, pic, false), translate.message('likes', { likes: pic.likes }));
  }

  function like(picture, liked) {
    picture.liked = liked;
    picture.likes += liked ? 1 : -1;
    var newElem = render(picture);
...
},{"../translate":84,"yo-yo":68}],78:[function(require,module,exports){
'use strict';
...
},{"./template":79,"page":58}],79:[function(require,module,exports){
'use strict';
...
var signInForm = yo(_templateObject, translate.message('signup.facebook'), translate.message('signup.text'), translate.message('signup.username'), translate.message('signup.password'), translate.message('signup.text'), translate.message('signin.not-have-acoount'), translate.message('signup.call-to-action'));
...
},{"./template":81,"page":58}],81:[function(require,module,exports){
'use strict';
...
var signUpForm = yo(_templateObject, translate.message('sigup.subheading'), translate.message('signup.facebook'), translate.message('signup.text'), translate.message('signup.email'), translate.message('signup.email'), translate.message('signup.username'), translate.message('signup.password'), translate.message('signup.call-to-action'), translate.message('signup.have-account'), translate.message('signin'));
...
module.exports = {
        ...
        'english': 'English',
        'spanish': 'Spanish',
        'sigup.subheading': 'Sign up to share your photos',
        'signup.facebook': 'Signup with your Facebook account',
        'signup.text': 'Signup',
        'signup.email': 'Email',
        ...
        'signin': 'Signin',
        'signin.not-have-acoount': 'Don\'t have an account?',
        'language': 'Language',
        'upload': 'Upload'
};
...
module.exports = {
  ...
  'english': 'Inglés',
  'spanish': 'Español',
  'sigup.subheading': 'Registrate para compartir tus fotos',
  ...
  'signin': 'Entrar',
  'signin.not-have-acoount': 'No tienes una cuenta?',
  'language': 'Idioma',
  'upload': 'Subir'
};
...
module.exports = {
  message: function message(text) {
    ...
    var mf = new IntlMessageFormat(MESSAGES[locale][text], locale, /*format*/null);
...
},{"./en-us":82,"./es":83,"intl":53,"intl-messageformat":38,"intl-relativeformat":47,"intl-relativeformat/dist/locale-data/en.js":45,"intl-relativeformat/dist/locale-data/es.js":46}]},{},[74]);
